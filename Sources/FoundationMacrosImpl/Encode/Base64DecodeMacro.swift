...
public struct Base64DecodeMacro: ExpressionMacro {
    public enum Error: Swift.Error, Diagnostiable {
        ...
        public var description: String {
            ...
            case .invalidBase64String(let string):
                return "not a valid base64 decodable string: '\(string)'"
            }
        }
    }
    ...
    public static func expansion(of node: some FreestandingMacroExpansionSyntax, in context: some MacroExpansionContext) throws -> ExprSyntax {
        ...
        guard let data = Data(base64Encoded: literalValue),
